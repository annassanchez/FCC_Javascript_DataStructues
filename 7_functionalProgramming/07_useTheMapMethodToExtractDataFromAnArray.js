...
//also we have seen the value in having a function only depends on its input arguments
...
//functions are considered first class objects in js, which means they can be used like any other object
//they can be saved in variables, stored in an object, or passed as funtion arguments
//let's start with some simple array functions, which are methods on the array object prototype
//in this exercise we are looking at Array.prototype.map(), or simply map()
...
//example: the watchList array holds objects with information on several movies
//use map on watchist to assign a new array objects to the ratings available
//each movie in the new array have only a title key with the name of the film, and a rating key with the IMDB rating
