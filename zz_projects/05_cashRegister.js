//design a cash register drawer function that accepts purchase price as a first argument (price), payment as the second (cash), and cash in the drawer as third argument (cid)
//cd is a 2d array listing avaylable currency
//the function should always return an object with a status key and a change key
//return {status: "INSUFICIENT_FUNDS", change: []} if cid is less than the change due, or if you cannot return the exact change
